...
public class signupproffesional extends Basepage
{
WebDriver driver;
public signupproffesional(WebDriver driver)
{
super(driver);
this.driver=driver;
}
...
public void upass(String userpwd)
{
txtpassword.sendKeys(userpwd);
}
public void cpass(String confirmpwd)
{
txtconfpassword.sendKeys(confirmpwd);
}
public void termsc()
{
btntc.click();
